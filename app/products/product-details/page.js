...
export default function page() {
  ...
  const data = {
    ...
    products: [
      ...
      link:'/products/digital-stethoscope',
      price: "$25.00",
      originalPrice: "$35.00",
      rating: [1, 1, 1, 0.5, 0] 
      },
...
{/* <ReactImageMagnify {...{
  ...
  largeImage: {
    ...
    height: 900
      ...
      <div className="flex flex-col lg:flex-row px-5 md:px-10 lg:px-16 py-10 lg:py-16 lg:gap-10">
        <div className="lg:w-2/3 flex flex-col h-auto lg:p-0 space-y-10 lg:space-y-16">
          <div className="flex flex-col md:flex-row md:gap-7 lg:gap-10">
             
           <img  src='/cosmetic.webp' className="w-1/2 h-auto"/>
            ...
            <div className="flex flex-col space-y-6 py-5">
              ...
              <div className="inline-flex space-x-2 items-center">
                <del className="font-bold text-xs md:text-base  text-green-500">
                  $180.00
                </del>
                <span className="font-bold text-xs md:text-lg text-green-600">
                  $150.00
                </span>
              </div>
              ...
              <div className="rounded-md max-w-full">
                <form id="contact-form" onSubmit={handleSubmit} >
                  <div className="grid grid-cols-1 gap-6">
                    <div className="flex flex-col">
                      <label className="mb-1 text-gray-700" htmlFor="name">Write your review *</label>
                      <textarea
                        name="message"
                        id="message"
                        ...
                        placeholder=""
                        className="p-1 border border-gray-300 focus:outline-none  h-32"
                      />
                    </div>
                    <div className="flex flex-col">
                    ...
                    <div className="flex flex-col">
                      <label className="mb-1 text-gray-700" htmlFor="name">Email *</label>
                      <input
                        type="email"
                        name="email"
                        id="email"
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={handleChange}
                        className="h-4 w-4 text-[#0a9a73] focus:ring-[#0a9a73] border-gray-300 rounded"
                      />
          ...
          <div className="flex flex-col space-y-5">
            <h1 className="text-xl font-semibold border-l-2 border-[#0a9a73] pl-3">Related Products</h1>
        ...
        <div className="flex flex-col w-full lg:w-1/3 space-y-5 ">
          <div className="md:w-full flex flex-col h-auto bg-white lg:border lg:border-slate-200 rounded-xl lg:items-center lg:px-6 lg:py-10 lg:space-y-3">
                ...
                {data.products.map((product) => (
                  <div key={product.id} className="flex gap-7 ">
                    ...
                    <div className="flex flex-col justify-center space-y-1 ">
                      ...
                      <p className="text-xs md:text-base font-semibold hover:text-[#0a9a73]">
                        {product.title}
                      </p>
                      </Link>
                    </div>
          ...
          <div className="md:w-full h-auto bg-white rounded-xl items-center lg:px-6 py-7 space-y-6 lg:border lg:border-slate-200">
            <h3 className="text-xl font-semibold border-l-2 border-[#0a9a73] pl-3 ">
              Search Objects
            </h3>
          ...
          <img src="/productimg.webp" className="lg:sticky lg:top-20 lg:z-[-1px]"/>
        </div>
      </div>
    </div>
  );
